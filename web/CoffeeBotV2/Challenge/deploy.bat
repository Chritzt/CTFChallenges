...
docker run --name coffeebotv2-chall --rm -p 127.0.0.1:8080:8080 -t -i -e HOST=127.0.0.1 -e PORT=80 -e TIMEOUT=30  --read-only --privileged --platform linux/amd64 localhost/coffeebotv2
goto :eof

:kill
echo [-] Stopping Challenge Container
docker stop coffeebotv2-chall >nul 2>&1
goto :eof
